document.addEventListener("DOMContentLoaded",function(){
    let formularioAjaxMYSQL = document.getElementById("formularioClientes");
...
function peticionClientes(){
    let divResultado =  document.getElementById("resultadoClientes");
    divResultado.innerHTML = "";
    document.getElementById("spinner").style ="display:block";
    miXHR = new objetoXHR();
    miXHR.open("GET", "clientes/servidor/mostrarClientes.php", true);
...
function crearTablaJSON(respuesta){
    ...
    let salida="<table border='1'><tr><th>NOMBRE</th><th>APELLIDOS</th><th>PRODUCTO</th></tr>";

    for (let i=0; i < resultados.length; i++){
        let objeto = resultados[i];
        salida+="<tr><td>"+objeto.nombre+"</td><td>"+
        objeto.apellidos+"</td><td>"+objeto.producto+"</td><td>";
    }
