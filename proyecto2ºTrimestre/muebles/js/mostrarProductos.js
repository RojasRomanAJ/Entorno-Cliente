...
function peticionProductos(){
    ...
    miXHR = new objetoXHR();
    miXHR.open("GET", "muebles/servidor/mostrarProductos.php", true);
...
function crearTablaJSON(respuesta){
    ...
    let salida="<table border='1'><tr><th>NOMBRE</th><th>TIPO</th><th>TAMAÑO</th><th>DESCRIPCION</th><th>PRECIO</th></tr>";

    for (let i=0; i < resultados.length; i++){
        let objeto = resultados[i];
        salida+="<tr><td>"+objeto.nombre+"</td><td>"+
        objeto.tipo+"</td><td>"+objeto.tamanio+"</td><td>"+
        objeto.descripcion+"</td><td>"+objeto.precio+"</td><td>";
    }
