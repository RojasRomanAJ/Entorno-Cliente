...
function realizarPeticionTipo(){
    ...
    miXHR.open("POST", "muebles/servidor/busquedaTipo.php", true);
...
function crearTablaJSON(respuesta){
    ...
    let salida = "<table border='1'<tr><th>ID</th><th>NOMBRE</th><th>TIPO</th><th>TAMAÑO</th><th>DESCRIPCIÓN</th><th>PRECIO</th></tr>";
