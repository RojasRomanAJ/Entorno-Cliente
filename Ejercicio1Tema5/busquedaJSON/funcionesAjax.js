...
function crearTablaJSON(respuesta){
    ...
    let salida = "<table border='1'<tr><th>ID</th><th>MARCA</th><th>TIPO</th><th>DISPONIBILIDAD</th><th>DESCRIPCIÓN</th></tr>";

    for (let i = 0; i < resultados.length; i++){
        let objeto = resultados[i];
        salida += "<tr><td>"+objeto.id+"</td><td>"+objeto.marca+"</td><td>"+
        objeto.tipo+"</td><td>"+objeto.disponibilidad+"</td><td>"+
